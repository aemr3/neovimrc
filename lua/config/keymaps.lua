...
map("n", "<Tab>", "]b", { desc = "Next buffer", remap = true })
map("n", "<S-Tab>", "[b", { desc = "Previous buffer", remap = true })
...
map("n", "<leader>qq", quit, { desc = "Quit all" })
map("i", "<S-Tab>", "<C-d>", { desc = "Unindent" })
map("n", "<leader>cw", "<cmd>set wrap!<cr>", { desc = "Toggle Word Wrap" })

-- Tools
map("n", "<leader>ll", "<cmd>Lazy<cr>", { desc = "Lazy" })

-- Split tmux window
map("n", "<leader>dx", "<cmd>!tmux split-window -v<cr>", { desc = "Split tmux window" })
